                            ...
                            <table className="w-full">
                                ...
                                <tbody className="divide-y divide-muted dark:divide-muted-foreground">
                                    ...
                                    <tr>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <span className='font-medium text-green-700 bg-green-100 px-2 py-1 rounded-full text-xs'>Aprovado</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td className="px-6 py-4 whitespace-nowrap font-medium">Bauru</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-muted-foreground">Pedro Costa</td>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <span className='font-medium text-red-700 bg-red-100 px-2 py-1 rounded-full text-xs'>Rejeitado</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
